...
export default function AddNoteForm({ onAdded }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-[var(--panel)] border border-[var(--edge)] rounded-xl p-5 mb-10">
      <label className="block font-mono text-xs text-[var(--mute)] mb-2" htmlFor="raw-notes">
        Pegá tus notas nuevas del curso
      </label>
      <textarea
        id="raw-notes"
        value={text}
        ...
        placeholder="Pegá texto de la lección, comandos, definiciones..."
      />
      <div className="flex items-center gap-3 mt-3">
        ...
        >
          {loading ? 'Organizando…' : 'Agregar módulo'}
        </button>
